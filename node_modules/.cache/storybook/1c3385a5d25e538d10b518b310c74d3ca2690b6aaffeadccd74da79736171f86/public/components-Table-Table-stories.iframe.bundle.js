"use strict";
(self["webpackChunkcontasy_ui"] = self["webpackChunkcontasy_ui"] || []).push([["components-Table-Table-stories"],{
...
/* harmony export */ });
/* harmony import */ var _Table_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Table.js */ "./src/components/Table/Table.js");
/* harmony import */ var _Badge_Badge_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Badge/Badge.js */ "./src/components/Badge/Badge.js");
/* harmony import */ var _tokens_variables_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../tokens/variables.css */ "./src/tokens/variables.css");
...
const billingColumns = [{
  ...
  label: 'Descrição',
  sortable: true,
  render: (val, row) => row.href ? `<a class="c-table__link" href="${row.href}">${val}</a>` : val
}, {
  key: 'periodo',
  label: 'Período',
  sortable: false
  ...
  render: val => {
    ...
    const badge = (0,_Badge_Badge_js__WEBPACK_IMPORTED_MODULE_1__.createBadge)({
      label: val,
      variant: map[val] || 'neutral'
    });
    return badge;
  }
}, {
...
const BillingTable = {
  render: () => {
    ...
    wrap.appendChild((0,_Table_js__WEBPACK_IMPORTED_MODULE_0__.createTable)({
      ...
      pagination: {
        ...
        total: 2,
        perPage: 10,
        onChange: p => /* eslint-disable */console.log(...oo_oo(`4018804331_62_69_62_91_4`, 'page', p))
      }
    }));
    return wrap;
  },
...
const Sortable = {
  render: () => {
    const cols = [{
      ...
      key: 'status',
      label: 'Status',
      render: v => (0,_Badge_Badge_js__WEBPACK_IMPORTED_MODULE_1__.createBadge)({
        label: v,
        variant: v === 'Ativo' ? 'success' : 'warning'
      })
    }];
    const rows = [{
      nome: 'João Silva',
...
;
const __namedExportsOrder = ["BillingTable", "EmptyState", "Sortable"];
BillingTable.parameters = {
  ...BillingTable.parameters,
  docs: {
    ...BillingTable.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => {\n    const wrap = document.createElement('div');\n    wrap.style.cssText = 'padding:24px; max-width:900px;';\n    wrap.appendChild(createTable({\n      columns: billingColumns,\n      rows: billingRows,\n      pagination: {\n        page: 1,\n        total: 2,\n        perPage: 10,\n        onChange: p => /* eslint-disable */console.log(...oo_oo(`4018804331_62_69_62_91_4`, 'page', p))\n      }\n    }));\n    return wrap;\n  },\n  parameters: {\n    controls: {\n      disable: true\n    }\n  }\n}",
      ...BillingTable.parameters?.docs?.source
    }
  }
};
...
Sortable.parameters = {
  ...Sortable.parameters,
  docs: {
    ...Sortable.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => {\n    const cols = [{\n      key: 'nome',\n      label: 'Nome',\n      sortable: true\n    }, {\n      key: 'empresa',\n      label: 'Empresa',\n      sortable: true\n    }, {\n      key: 'valor',\n      label: 'Valor',\n      sortable: true\n    }, {\n      key: 'status',\n      label: 'Status',\n      render: v => createBadge({\n        label: v,\n        variant: v === 'Ativo' ? 'success' : 'warning'\n      })\n    }];\n    const rows = [{\n      nome: 'Jo\xE3o Silva',\n      empresa: 'Tech LTDA',\n      valor: 'R$ 1.200,00',\n      status: 'Ativo'\n    }, {\n      nome: 'Maria Souza',\n      empresa: 'Digital ME',\n      valor: 'R$ 850,00',\n      status: 'Pendente'\n    }, {\n      nome: 'Carlos Lima',\n      empresa: 'Fast EIRELI',\n      valor: 'R$ 2.400,00',\n      status: 'Ativo'\n    }, {\n      nome: 'Ana Costa',\n      empresa: 'Prime LTDA',\n      valor: 'R$ 350,00',\n      status: 'Pendente'\n    }];\n    const wrap = document.createElement('div');\n    wrap.style.cssText = 'padding:24px; max-width:800px;';\n    wrap.appendChild(createTable({\n      columns: cols,\n      rows,\n      pagination: {\n        page: 1,\n        total: 4,\n        perPage: 10\n      }\n    }));\n    return wrap;\n  },\n  parameters: {\n    controls: {\n      disable: true\n    }\n  }\n}",
      ...Sortable.parameters?.docs?.source
    }
  }
};
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].use[1]!./src/components/Table/Table.css"
/*!**********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].use[1]!./src/components/Table/Table.css ***!
  \**********************************************************************************************************/
...
.c-table__head th.is-sortable:hover {
  color: var(--color-text);
}

.c-table__head th.is-sorted {
...
.c-table__head th.is-sortable:hover .c-table__sort-icon,
.c-table__head th.is-sorted .c-table__sort-icon {
  opacity: 1;
}
...
.c-pagination__btn.is-active {
  ...
  box-shadow: 0 4px 12px rgba(244, 91, 122, 0.35);
}
...
`, "",{"version":3,"sources":["webpack://./src/components/Table/Table.css"],"names":[],"mappings":"AAAA;;iEAEiE;;AAEjE;EACE,WAAW;EACX,gBAAgB;EAChB,+BAA+B;EAC/B,qCAAqC;EACrC,gCAAgC;EAChC,iCAAiC;AACnC;;AAEA;EACE,WAAW;EACX,yBAAyB;EACzB,8BAA8B;AAChC;;AAEA,iBAAiB;AACjB;EACE,2BAA2B;EAC3B,4CAA4C;AAC9C;;AAEA;EACE,4CAA4C;EAC5C,gBAAgB;EAChB,8BAA8B;EAC9B,wCAAwC;EACxC,8BAA8B;EAC9B,yBAAyB;EACzB,qBAAqB;EACrB,mBAAmB;EACnB,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,iCAAiC;EACjC,wCAAwC;AAC1C;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;EACE,kBAAkB;EAClB,wBAAwB;EACxB,QAAQ;EACR,2BAA2B;EAC3B,aAAa;EACb,sBAAsB;EACtB,QAAQ;EACR,YAAY;EACZ,0CAA0C;AAC5C;;AAEA;;EAEE,UAAU;AACZ;;AAEA,iBAAiB;AACjB;EACE,4CAA4C;EAC5C,6CAA6C;AAC/C;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;EACE,0BAA0B;EAC1B,wBAAwB;EACxB,sBAAsB;AACxB;;AAEA,sBAAsB;AACtB;EACE,2BAA2B;EAC3B,sCAAsC;EACtC,qBAAqB;EACrB;;0CAEwC;AAC1C;;AAEA;EACE,gCAAgC;EAChC,0BAA0B;AAC5B;;AAEA,wBAAwB;AACxB;EACE,kBAAkB;EAClB,8CAA8C;EAC9C,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,gCAAgC;EAChC,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,oBAAoB;EACpB,UAAU;EACV,iBAAiB;AACnB;;AAEA;EACE,8BAA8B;EAC9B,sCAAsC;EACtC,gCAAgC;AAClC;;AAEA;EACE,8BAA8B;AAChC;;AAEA;;iEAEiE;;AAEjE;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,6CAA6C;EAC7C,8BAA8B;EAC9B,8BAA8B;EAC9B,sBAAsB;EACtB,eAAe;AACjB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,WAAW;EACX,YAAY;EACZ,iCAAiC;EACjC,uCAAuC;EACvC,8BAA8B;EAC9B,8BAA8B;EAC9B,8BAA8B;EAC9B,sCAAsC;EACtC,eAAe;EACf;;;gCAG8B;EAC9B,+BAA+B;AACjC;;AAEA;EACE,kCAAkC;EAClC,2BAA2B;AAC7B;;AAEA;EACE,gCAAgC;EAChC,kCAAkC;EAClC,yBAAyB;EACzB,+CAA+C;AACjD;;AAEA;EACE,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,oBAAoB;EACpB,UAAU;EACV,iBAAiB;EACjB,qBAAqB;EACrB,sBAAsB;AACxB","sourcesContent":["/* ============================================================\r\n   TABLE COMPONENT\r\n   ============================================================ */\r\n\r\n.c-table-wrapper {\r\n  width: 100%;\r\n  overflow-x: auto;\r\n  border-radius: var(--radius-lg);\r\n  border: 1px solid var(--color-border);\r\n  background: var(--color-surface);\r\n  -webkit-overflow-scrolling: touch;\r\n}\r\n\r\n.c-table {\r\n  width: 100%;\r\n  border-collapse: collapse;\r\n  font-size: var(--font-size-sm);\r\n}\r\n\r\n/* --- Head --- */\r\n.c-table__head {\r\n  background: var(--color-bg);\r\n  border-bottom: 2px solid var(--color-border);\r\n}\r\n\r\n.c-table__head th {\r\n  padding: var(--spacing-md) var(--spacing-lg);\r\n  text-align: left;\r\n  font-size: var(--font-size-xs);\r\n  font-weight: var(--font-weight-semibold);\r\n  color: var(--color-text-muted);\r\n  text-transform: uppercase;\r\n  letter-spacing: 0.6px;\r\n  white-space: nowrap;\r\n  user-select: none;\r\n}\r\n\r\n.c-table__head th.is-sortable {\r\n  cursor: pointer;\r\n  position: relative;\r\n  padding-right: var(--spacing-2xl);\r\n  transition: color var(--transition-fast);\r\n}\r\n\r\n.c-table__head th.is-sortable:hover {\r\n  color: var(--color-text);\r\n}\r\n\r\n.c-table__head th.is-sorted {\r\n  color: var(--color-primary);\r\n}\r\n\r\n.c-table__sort-icon {\r\n  position: absolute;\r\n  right: var(--spacing-sm);\r\n  top: 50%;\r\n  transform: translateY(-50%);\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 1px;\r\n  opacity: 0.4;\r\n  transition: opacity var(--transition-fast);\r\n}\r\n\r\n.c-table__head th.is-sortable:hover .c-table__sort-icon,\r\n.c-table__head th.is-sorted .c-table__sort-icon {\r\n  opacity: 1;\r\n}\r\n\r\n/* --- Body --- */\r\n.c-table__body tr {\r\n  border-bottom: 1px solid var(--color-border);\r\n  transition: background var(--transition-fast);\r\n}\r\n\r\n.c-table__body tr:last-child {\r\n  border-bottom: none;\r\n}\r\n\r\n.c-table__body tr:hover {\r\n  background: var(--color-bg);\r\n}\r\n\r\n.c-table__body td {\r\n  padding: var(--spacing-lg);\r\n  color: var(--color-text);\r\n  vertical-align: middle;\r\n}\r\n\r\n/* --- Link cell --- */\r\n.c-table__link {\r\n  color: var(--color-primary);\r\n  font-weight: var(--font-weight-medium);\r\n  text-decoration: none;\r\n  transition:\r\n    color var(--transition-fast),\r\n    text-decoration var(--transition-fast);\r\n}\r\n\r\n.c-table__link:hover {\r\n  color: var(--color-primary-dark);\r\n  text-decoration: underline;\r\n}\r\n\r\n/* --- Empty state --- */\r\n.c-table__empty {\r\n  text-align: center;\r\n  padding: var(--spacing-3xl) var(--spacing-2xl);\r\n  color: var(--color-text-muted);\r\n}\r\n\r\n.c-table__empty-icon {\r\n  display: flex;\r\n  justify-content: center;\r\n  margin-bottom: var(--spacing-md);\r\n  opacity: 0.3;\r\n}\r\n\r\n.c-table__empty-icon svg {\r\n  width: 48px;\r\n  height: 48px;\r\n  stroke: currentColor;\r\n  fill: none;\r\n  stroke-width: 1.5;\r\n}\r\n\r\n.c-table__empty-text {\r\n  font-size: var(--font-size-md);\r\n  font-weight: var(--font-weight-medium);\r\n  margin-bottom: var(--spacing-xs);\r\n}\r\n\r\n.c-table__empty-sub {\r\n  font-size: var(--font-size-sm);\r\n}\r\n\r\n/* ============================================================\r\n   PAGINATION\r\n   ============================================================ */\r\n\r\n.c-pagination {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n  padding: var(--spacing-lg) var(--spacing-2xl);\r\n  font-size: var(--font-size-sm);\r\n  color: var(--color-text-muted);\r\n  gap: var(--spacing-lg);\r\n  flex-wrap: wrap;\r\n}\r\n\r\n.c-pagination__info {\r\n  white-space: nowrap;\r\n}\r\n\r\n.c-pagination__controls {\r\n  display: flex;\r\n  align-items: center;\r\n  gap: var(--spacing-xs);\r\n}\r\n\r\n.c-pagination__btn {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  width: 34px;\r\n  height: 34px;\r\n  border-radius: var(--radius-full);\r\n  border: 1.5px solid var(--color-border);\r\n  background: var(--color-white);\r\n  color: var(--color-text-muted);\r\n  font-size: var(--font-size-sm);\r\n  font-weight: var(--font-weight-medium);\r\n  cursor: pointer;\r\n  transition:\r\n    background var(--transition-fast),\r\n    border-color var(--transition-fast),\r\n    color var(--transition-fast);\r\n  font-family: var(--font-family);\r\n}\r\n\r\n.c-pagination__btn:hover:not(:disabled) {\r\n  border-color: var(--color-primary);\r\n  color: var(--color-primary);\r\n}\r\n\r\n.c-pagination__btn.is-active {\r\n  background: var(--color-primary);\r\n  border-color: var(--color-primary);\r\n  color: var(--color-white);\r\n  box-shadow: 0 4px 12px rgba(244, 91, 122, 0.35);\r\n}\r\n\r\n.c-pagination__btn:disabled {\r\n  opacity: 0.4;\r\n  cursor: not-allowed;\r\n}\r\n\r\n.c-pagination__btn svg {\r\n  width: 14px;\r\n  height: 14px;\r\n  stroke: currentColor;\r\n  fill: none;\r\n  stroke-width: 2.5;\r\n  stroke-linecap: round;\r\n  stroke-linejoin: round;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].use[1]!./Table.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].use[1]!./src/components/Table/Table.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);


if (true) {
  if (!_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals || module.hot.invalidate) {
  ...
  return true;
    ...
    var isNamedExport = !_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;
    var oldLocals = isNamedExport ? _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__ : _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;

    module.hot.accept(
      /*! !!../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].use[1]!./Table.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].use[1]!./src/components/Table/Table.css",
      __WEBPACK_OUTDATED_DEPENDENCIES__ => { /* harmony import */ _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].use[1]!./Table.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].use[1]!./src/components/Table/Table.css");
 return (function () {
        if (!isEqualLocals(oldLocals, isNamedExport ? _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__ : _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals, isNamedExport)) {
                module.hot.invalidate();

                return;
              }

              oldLocals = isNamedExport ? _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__ : _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;

              update(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"]);
      })(__WEBPACK_OUTDATED_DEPENDENCIES__); }
    )
  }
  ...
  module.hot.dispose(function() {
    update();
       ...
       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_7_use_1_Table_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony export */ });
/* harmony import */ var _Table_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Table.css */ "./src/components/Table/Table.css");

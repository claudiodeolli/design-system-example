...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\Cláudio de Oliveira\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.527\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '206c7b054a88c34bf406a2A00GUgYbBltcD1VXAVsFBgQHBQAG', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/Cl%C3%A1udio%20de%20Oliveira/.vscode/extensions/wallabyjs.console-ninja-1.0.527/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '206c7b054a88c34bf406a2A00GUgYbBltcD1VXAVsFBgQHBQAG', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
